...
def insights_page():
    ...
    st.title("📊 Model Insights and Telco Dataset Analysis")
    ...
    with chart_col1:
        ...
        fig1, ax1 = plt.subplots(figsize=(5, 4), dpi=10)
    ...
    with chart_col2:
        ...
        fig2, ax2 = plt.subplots(figsize=(5, 4), dpi=10)
    ...
    with col5:
        ...
        fig5, ax5 = plt.subplots(figsize=(5, 4), dpi=50)
    ...
    sns.barplot(data=coef_df.head(10), x='Coefficient', y='Feature', ax=ax6, palette='rocket',hue='Feature',legend=False)
    ...
    - **Model Selection**: The model was trained using three different techniques: Logistic Regression, MLP Classifier, and Decision Tree. The performance of these models was compared, and from this analysis, Logistic Regression was determined to be the best model.
    """)
